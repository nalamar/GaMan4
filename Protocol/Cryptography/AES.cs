...
namespace Protocol.Cryptography
{
    ...
    /// <see cref="http://msdn.microsoft.com/en-us/magazine/cc164055.aspx"/>
    /// </summary>
    public class AES
    {
        ...
        /// <returns>A byte array with the cipher text</returns>
        ...
        private void AES_ShowError(Exception e, string FunctionName)
        {
            string errMsg = "";
            string nl = "\r\n";
            ...
            try
            {
                ...
                errMsg += "Source: " + e.Source + nl;
                errMsg += "Error Description: " + nl + e.Message;
